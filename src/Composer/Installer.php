...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, $doInstall)
    {
        ...
        if (Platform::getEnv('COMPOSER_TESTS_ARE_RUNNING')) {
        ...
        if (!Platform::getEnv('COMPOSER_TESTS_ARE_RUNNING') && Platform::getEnv('COMPOSER_POOL_OPTIMIZER')) {
            try {
                ...
                $lockTransaction2 = $solver2->solve($request, $this->ignorePlatformReqs);
